...
//  Demo
//
//  Created by Anup Kumar Mishra on 12/08/23.
//
...
//        let apiurl = APILoginUtility.studentExamTestApi
        guard let url = URL(string: "https://www.alibrary.in/api/publisher/dashboard") else {
...
struct PublisherLoginSidemenuView: View {
    @StateObject private var loginVM = GetAuthenticationViewModel()
    @State var presentSideMenu = false
    @State var selectedSideMenuTab = 0
    @State private var selected: PublisherSelectedScreen = .dashboard
    var body: some View {
        ZStack{
            NavigationView{
