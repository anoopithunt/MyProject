//
//  SchoolDashBoardView.swift
//  Demo
//
//  Created by Sandeep Kesarwani on 25/10/23.
//
...
struct SchoolDashBoardView_Previews: PreviewProvider {
    static var previews: some View {
        SchoolLoginSidemenuView()
    }
}


enum SchoolSelectedScreen {
    case home
...
struct SchoolLoginSidemenuView: View {
//    @StateObject private var loginVM = GetAuthenticationViewModel()
    @State var presentSideMenu = false
    @State var selectedSideMenuTab = 0
    @State private var selected: SchoolSelectedScreen = .dashboard
    var body: some View {
        ZStack{
            NavigationView{
