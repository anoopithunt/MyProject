...
//MARK: In this View I am trying to fetch the data MAC Addresss of device and Device model Name and Restrict of Screen shot Capturing.
           ...
           (Color.green).ignoresSafeArea()
            ...
            VStack(alignment: .leading){
                ScrollView{
                    ...
                    .cornerRadius(8).shadow(radius:2)
                    .padding()
...
//                        .foregroundColor(.clear)
                    HStack{
                        VStack{
                            Spacer()
                            ZStack{
                                Circle().frame(width:93, height: 93).foregroundColor(.green)
                                Text("Hello")
                        ...
                        VStack{
                            HStack{
                                Spacer()
                                ZStack{
                                    Circle().frame(width:93, height: 93).foregroundColor(.yellow)
                                    Text("Yummy")
