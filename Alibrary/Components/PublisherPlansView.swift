...
struct PublisherPlansView: View{
    @StateObject var list = PublisherPlanViewModel()
                    ...
                    ScrollView(showsIndicators: false){
                        VStack{
                            ...
                            HStack(alignment: .center, spacing: nil) {
                                ...
                                ForEach(list.headings, id: \.self){ heading in
...
struct PublisherPlansView_Previews: PreviewProvider {
