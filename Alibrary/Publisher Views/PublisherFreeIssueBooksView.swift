//
//  PublisherFreeIssueBooksView.swift
//  Alibrary
//
...
struct PublisherFreeIssueBooksView_Previews: PreviewProvider {
    static var previews: some View {
        PublisherFreeIssueBooksView()
    }
}
