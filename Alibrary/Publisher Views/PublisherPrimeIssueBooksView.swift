//
//  PublisherPrimeIssueBooksView.swift
//  Alibrary
//
...
struct PublisherPrimeIssueBooksView_Previews: PreviewProvider {
    static var previews: some View {
        PublisherPrimeIssueBooksView()
    }
}
